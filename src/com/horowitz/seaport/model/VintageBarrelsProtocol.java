...
public class VintageBarrelsProtocol extends AbstractGameProtocol {
	...
	public VintageBarrelsProtocol(ScreenScanner scanner, MouseRobot mouse) throws IOException {
		blobMin = 15 * 20;
		blobMax = 28 * 32;
		_scanner = scanner;
		_mouse = mouse;
